...
def gameclose():
    print("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n")
    dragon()
    raw_input("Thanks for playing, press enter to quit")
    quit()
...
def gamestart():
  while game:
    ...
    activity = raw_input("What do you want to do? (Look for a fight, Visit healers, Quit)")
    ...
    if activity == "Look for a fight":
      ...
      if fightnum == 1:
        ...
        fightsus = raw_input("Do you want to fight the Turtle? (yes, no)")
        if fightsus == "yes":
          anhealth = 15
          print("\n\n\nTurtle hits you")
          ...
          #addcodehere
          raw_input("Press any enter to go back")
        else:
          print("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nWelcome to Eternity")
          print(" ________")
          print("| |____| |")
...
def setup():
  while setuploop:
    gm = "False"
    st = "False"
    charname = raw_input("What do you want your name to be: ")
    chargen = raw_input("Pick a gender (male, female, other): ")
    setupcomfin = "True"
    while setupcomfin:
      print("\n\n\n\n\n\n\n\n\n\nPlease check that this is what you want")
      charconfirm = raw_input("Are you sure you want your name to be " + str(charname) + str("\nAnd your gender to be ") + str(chargen) + str("? (yes, no): "))
      if charconfirm == "yes":
  ...
  while gm:
    ...
    if returnpromt == "yes":
      ...
      while prmtut:
        ...
        promttut = raw_input("Here is an example, do you understand the format yet? (yes, no): ")
        if promttut == "no":
